...
public:
    ...
    modal_tree_node(unsigned id, bool named, syntax_tree_node* abs, modal_tree_node* parent, const z3::expr& world_constant, const z3::expr& aux_predicate) : m_id(id), m_named(named), m_abstract(abs), m_parent(parent), m_world_constant(world_constant), m_aux_predicate(aux_predicate) {}
