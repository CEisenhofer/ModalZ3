...
(assert (not (or (or (box r (box r (box r (box r (box r (box r (box r (and (and (and (and (and (and (p1 world) (p2 world)) (p3 world)) (p4 world)) (p5 world)) (p6 world)) (p7 world))))))))) (or (dia r (or (or (dia r (or (or (dia r (or (or (dia r (or (or (dia r (or (or (dia r (or false (dia r (= (p1 world) (p2 world))))) (box r (p3 world))) (dia r (dia r (= (p2 world) (p3 world)))))) (box r (p4 world))) (dia r (dia r (dia r (= (p3 world) (p4 world))))))) (box r (p5 world))) (dia r (dia r (dia r (dia r (= (p4 world) (p5 world)))))))) (box r (p6 world))) (dia r (dia r (dia r (dia r (dia r (= (p5 world) (p6 world))))))))) (box r (p7 world))) (dia r (dia r (dia r (dia r (dia r (dia r (= (p6 world) (p1 world)))))))))) (box r (p8 world)))) (box r (box r (box r (box r (box r (box r (box r (and (and (and (and (and (and (not (p2 world)) (not (p4 world))) (not (p6 world))) (not (p8 world))) (not (p10 world))) (not (p12 world))) (not (p14 world)))))))))))))
